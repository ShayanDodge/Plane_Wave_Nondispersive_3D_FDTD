...
%% FDTD variables
number_of_cells_per_wavelength=25;
...
boundary.air_buffer_number_of_cells_zn=800;
...
%% update source
 Hy(1:nx,1:ny,n_cpml_zn+50)=Hy(1:nx,1:ny,n_cpml_zn+50)-amptidute *sin((number * dt - t0) * omega)/dz; % Sine source
